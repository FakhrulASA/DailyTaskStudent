...
public class PhoneAdapter extends RecyclerView.Adapter<PhoneAdapter.ViewHolder> {
    ...
    public PhoneAdapter(Context ctx, List<NoteModel> posts) {
        this.context=ctx;
        this.posts = posts;
    ...
    public PhoneAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.phone_list,parent,false);
    ...
    public void onBindViewHolder(@NonNull PhoneAdapter.ViewHolder holder, int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.collection("courselist").document(userid).collection("phones").document(posts.get(position).getId()).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            //initialize
            title=itemView.findViewById(R.id.title_list_note1);
            note=itemView.findViewById(R.id.note_list_note1);
            delete=itemView.findViewById(R.id.delete_note1);
        }
    }
}
